...
source("Scripts/MAP_WC.R",echo=TRUE,verbose = FALSE)
```
...
krugerIntensityInvestigationDF$IntensityCut <- cut(krugerIntensityInvestigationDF$FirelineIntensity,breaks = c(-500,1000,2000,4000,6000,8000))
levels(krugerIntensityInvestigationDF$IntensityCut) <- c("Very low (< 1000)","Low (1000 - 2000)","Moderate (2000 - 4000)","High (4000 - 6000)","Very Hight (> 6000)")

krugerIntensityInvestigationDF_agg <- ddply(krugerIntensityInvestigationDF,.(IntensityCut),summarize,Count = length(FirelineIntensity))

krugerIntensityInvestigationDF_agg$Percent <- krugerIntensityInvestigationDF_agg$Count / sum(krugerIntensityInvestigationDF_agg$Count)
...
FLI_Hist <- ggplot(data=krugerIntensityInvestigationDF_agg,aes(x=IntensityCut,y=Percent*100))+
 ...
 # scale_x_continuous(breaks=c(0,1000,2000,3000,4000,5000),labels=c(""))+
  ...
  geom_text(aes(label = Percent*100,y = Percent*100 + 5),parse=TRUE)+
